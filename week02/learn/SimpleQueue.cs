public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: It was trying to dequeue index 1 and not index 0.
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: It was putting the "enqueued" numbers on the front of the queue instead of the back. 
