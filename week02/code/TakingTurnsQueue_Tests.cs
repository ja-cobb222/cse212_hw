...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: GetNextPerson does not handle when a person's turn are exactly 1 and re-enters them into the queue. 
    ...
    // Defect(s) Found: Same as before - A person with 1 turn remaining is re-added to the queue
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: There is no code to handle this scenario. 
    ...
    // Defect(s) Found: As with the last test case, there is no code to handle this scenario. 
